...
def initialize_experiment(params, file_name):
    ...
    '''
    params.main_dir = os.path.join(os.path.relpath(os.path.dirname(os.path.abspath(__file__))), '..')  # 相对路径relpath
    ...
    with open(os.path.join(params.exp_dir, "params.json"), 'w') as fout:  # vars返回字典对象
